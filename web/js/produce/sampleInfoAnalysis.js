    ...
    $.ajax({
        ...
        success: function (result) {
            if (result != undefined && result.status == "success") {
                ...
                $("#viewTable").find("td[name='PH']").text(parseFloat(data.PH).toFixed(3));
                $("#viewTable").find("td[name='ash']").text(parseFloat(data.ash).toFixed(3));
                $("#viewTable").find("td[name='water']").text(parseFloat(data.water).toFixed(3));
                $("#viewTable").find("td[name='heat']").text(parseFloat(data.heat).toFixed(3));
                $("#viewTable").find("td[name='fluorine']").text(parseFloat(data.fluorine).toFixed(3));
                $("#viewTable").find("td[name='chlorine']").text(parseFloat(data.chlorine).toFixed(3));
                $("#viewTable").find("td[name='sulfur']").text(parseFloat(data.sulfur).toFixed(3));
                $("#viewTable").find("td[name='phosphorus']").text(parseFloat(data.phosphorus).toFixed(3));
                $("#viewTable").find("td[name='flashPoint']").text(parseFloat(data.flashPoint).toFixed(3));
                $("#viewTable").find("td[name='viscosity']").text(parseFloat(data.viscosity).toFixed(3));
                $("#viewTable").find("td[name='hotMelt']").text(parseFloat(data.hotMelt).toFixed(3));
