    ...
    $.ajax({
        ...
        success: function (result) {
            if (result != undefined && result.status == "success") {
                ...
                $("#viewFlashPoint").text(setNumber2Line(parseFloat(obj.flashPoint).toFixed(2)));
